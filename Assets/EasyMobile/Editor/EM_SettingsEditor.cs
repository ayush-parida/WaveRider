...
namespace EasyMobile.Editor
{
    ...
    internal partial class EM_SettingsEditor : UnityEditor.Editor
    {
        ...
        private static class AdProperties
        {
            ...
            public static EMProperty mopubInitNetworks = new EMProperty(null, new GUIContent("Initialize Networks"));
            public static EMProperty mopubAdvancedBidders = new EMProperty(null, new GUIContent("Advanced Bidders"));
            public static EMProperty mopubMediationSettings = new EMProperty(null, new GUIContent("Mediation Settings", "These dictionaries are serialized to JSON and passed to the native SDKs for handling, so the object values must be JSON-serializable"));
