...
public class CharacterScroller : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < CharacterManager.Instance.characters.Length; i++)
        {
            ...
            if (charData.IsUnlocked)
                charRdr.material.SetColor("_Color", charData.color);
            else
    ...
    void Update()
    {
        ...
        if (currentCharacter != lastCurrentCharacter)
        {
            ...
            { 
                ...
                lockedBtn.gameObject.SetActive(false);
            ...
            {   
                ...
                {
                    unlockBtn.gameObject.SetActive(false);
                    lockedBtn.gameObject.SetActive(true);
                }    
            }
        }
    }
    ...
    public void UnlockButton()
    {
        ...
        if (unlockSucceeded)
        {
            currentCharacter.GetComponent<Renderer>().material.SetColor("_Color", character.color);
            unlockBtn.gameObject.SetActive(false);
            selectBtn.gameObject.SetActive(true);
